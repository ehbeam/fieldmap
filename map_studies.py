...
# Execute mapping of studies
strategies = ["winner-takes-all", "probabilistic-winner-takes-all"]
sigmas = [5, 10, 15, 20, 25, 30, 35, 40, 45, 50]
behav_inputs = ["abstracts", "texts"]
lemmas = [True, None]
for strat in strategies:
	for sig in sigmas:
	    map("/Users/ehbeam/Dropbox/Stanford/Research/Projects/Psychiatlas/program/cogneuro", "coordinates", sigma = sig, anat = True, behav_input = None, lemmas = None, level = "studies", strategy = strat, smooth = True)
	    map("/Users/ehbeam/Dropbox/Stanford/Research/Projects/Psychiatlas/program/cogneuro", "coordinates", sigma = sig, func = True, behav_input = "brainmap", lemmas = None, level = "studies", strategy = strat, smooth = True)
	    for inp in behav_inputs:
	        for lem in lemmas:
	            map("/Users/ehbeam/Dropbox/Stanford/Research/Projects/Psychiatlas/program/cogneuro", sigma = sig, func = True, behav_input = inp, lemmas = lem, level = "studies", strategy = strat, smooth = True)
